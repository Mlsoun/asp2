...
namespace MVC.Controllers
{
    ...
    public class NewSocksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Size,Price,InStock")] NewSocks newSocks)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Size,Price,InStock")] NewSocks newSocks)
        {
            if (id != newSocks.Id)
            {
                return NotFound();
